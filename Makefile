...
pages_url    := https://the-ai-alliance.github.io/clinicamind-conversational-ai-for-healthcare/
docs_dir     := docs
...
# `localhost:4000/The-AI-Alliance/clinicamind-conversational-ai-for-healthcare` when running locally.
run-jekyll: clean
	@echo
